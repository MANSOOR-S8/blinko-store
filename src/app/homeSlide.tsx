            ...
            <div className="relative w-full h-full ">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white px-4 max-w-4xl mx-auto">
                  {/* <p className="text-sm sm:text-base md:text-lg uppercase tracking-wider mb-2 animate-fadeIn">
                    {slide.subtitle}
                  </p>
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 animate-slideUp">
                    {slide.title}
                  </h1>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 md:mb-8 animate-slideUp delay-200">
                    {slide.description}
                  </p> */}
                  <Link
